...
const modalPersonagem = (params) => {
  var modal =
    ...
    <button type="button" class="sem-fundo fechar position-relative som-fechar btn-ampliar" data-bs-dismiss="modal" aria-label="Close"><img class="img-fluid" src="assets/img/06botao_fechar.png" alt="Botão para voltar na tela inicial"></button>
